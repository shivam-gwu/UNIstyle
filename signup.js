    ...
    $scope.submit=function () {
        if (checkInput($scope)) {
            ...
            sendserverData();
             ...
             println("username: Allows alphanumeric characters and underscores, 3 to 20 characters");
             println("password: Requires at least 8 characters, one lowercase, one uppercase, and one digit");
        }
